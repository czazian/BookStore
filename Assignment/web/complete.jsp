...
<head>
    ...
    <link href="OrderCompletement/complete.css" rel="stylesheet">
...
<body>
    <div class="container-fluid">
        ...
        <div class="link">
            <button onclick="location.href='homepage.jsp'">Check Order Status</button>
        </div>
    </div>
</body>
...
<script src="OrderCompletement/complete.js"></script>
